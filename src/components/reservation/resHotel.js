...
return ;
        ...
        let d =new Date()
        res.post('/logs.json',{log:d.toLocaleString()+" : "+localStorage.getItem('agent')+" passé une réservation D'hotel Pour le client : "+NomCli})
        ...
        res.post("/hotels.json",{date:datenow,agent:localStorage.getItem('agent'),NomCli,NomHotel,dateEntree,Datesortie,nnuitees,prixAch:peixAch,PrixVente,TypeDepaiment,ModeDePaiment,deposit:premiertranche?PremTranche:PrixVente,Remarque})
        routemanger(0)
    }
